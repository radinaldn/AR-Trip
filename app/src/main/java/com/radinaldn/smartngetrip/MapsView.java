...
public class MapsView extends Activity implements OnMapLongClickListener, OnInfoWindowClickListener {
	...
	public void onStart() {
		...
		Action viewAction = Action.newAction(
				...
				Uri.parse("android-app://com.radinaldn.smartngetrip/http/host/path")
		);
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					for (int i = 0; i < dataMap.size(); i++) {
						...
						System.out.println("Marker ter generate");
						System.out.println(map.get("title"));
						Marker marker = myMap.addMarker(new MarkerOptions()
								.position(POSISI)
										.title(map.get("title"))
										.snippet(map.get("streetAddress"))
//								.icon(BitmapDescriptorFactory.fromResource(R.drawable.logo_user))
						);
//						marker.showInfoWindow();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(AWAL, 100));

...
import com.mixare.gui.PaintScreen;
import com.mixare.gui.ScreenLine;
import com.mixare.gui.ScreenObj;
import com.mixare.gui.TextObj;
import com.mixare.reality.PhysicalPlace;
import com.mixare.render.Camera;
import com.mixare.render.MixVector;
...
//	}
	...
	public void draw(PaintScreen dw) {
		...
		//adhastar modified (remove hard code)
		if (textBlock == null) {
			StringBuilder distanceKm = new StringBuilder();
			distanceKm.append(title);
			distanceKm.append("\n");
			distanceKm.append("(");
